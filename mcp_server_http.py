#!/usr/bin/env python3
"""
Serveur MCP avec transport HTTP/SSE pour ChatGPT et Claude Desktop.

Ce serveur expose les mêmes fonctionnalités que mcp_server.py mais via HTTP/SSE,
permettant la connexion depuis ChatGPT en mode développeur.

Différences avec mcp_server.py:
- Transport: SSE (Server-Sent Events) au lieu de stdio
- Accessible via HTTPS (ngrok, cloudflare tunnel, etc.)
- Authentification requise
- Compatible avec Claude Desktop ET ChatGPT

Pour Claude Desktop (local): utiliser mcp_server.py
Pour ChatGPT (remote): utiliser mcp_server_http.py
"""
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "threshold": {
                        "type": "number",
                        "description": "Seuil de similarité entre 0 et 1 (défaut: 0.3)",
                        "default": 0.3
                    }
                },
                "required": ["query"]
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "threshold": {
                        "type": "number",
                        "description": "Seuil de similarité (défaut: 0.3)",
                        "default": 0.3
                    }
                },
                "required": ["query"]
...
async def main():
    """Point d'entrée principal du serveur MCP HTTP/SSE."""
    ...
    logger.info("📡 Compatible: ChatGPT Developer Mode + Claude Desktop")

    # Créer le transport SSE
    # Le serveur SSE sera accessible via HTTP sur le port configuré
